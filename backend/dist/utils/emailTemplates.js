...
exports.enrollmentNotificationTemplate = exports.welcomeTemplate = exports.passwordResetTemplate = exports.emailVerifyTemplate = void 0;
const config_1 = require("../config/config");
const emailVerifyTemplate = (name, verifyUrl) => `
<!DOCTYPE html>
<html>
...
<body style="font-family: Arial, sans-serif; background: #0a0a0a; color: #fff; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: 40px auto; background: #1a1a2e; border-radius: 16px; overflow: hidden;">
    ...
    <div style="padding: 40px;">
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${config_1.config.frontend.url}/courses" style="
          background: linear-gradient(135deg, #7c3aed, #ec4899);
          color: white;
          text-decoration: none;
          padding: 14px 32px;
...
const enrollmentNotificationTemplate = (data) => `
<!DOCTYPE html>
<html>
...
<body style="font-family: Arial, sans-serif; background: #0a0a0a; color: #fff; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: 40px auto; background: #1a1a2e; border-radius: 16px; overflow: hidden;">
    ...
    <div style="padding: 40px;">
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${config_1.config.frontend.url}/admin/enrollments" style="
          background: linear-gradient(135deg, #7c3aed, #ec4899);
          color: white;
          text-decoration: none;
          padding: 14px 32px;
...
`;
exports.enrollmentNotificationTemplate = enrollmentNotificationTemplate;
