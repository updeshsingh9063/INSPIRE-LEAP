...
export const metadata = {
  title: "Login | Inspire Leap - Wipro Partner Program",
  description: "Sign in to your Inspire Leap account to access premium courses, track your progress, and connect with industry mentors.",
}
