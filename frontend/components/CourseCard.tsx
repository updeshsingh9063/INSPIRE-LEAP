...
export default function CourseCard({ course, viewMode }: CourseCardProps) {
  ...
  if (viewMode === "list") {
    return (
      <motion.div
        ...
        className="bg-white rounded-2xl p-6 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300"
      >
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/4 flex flex-col justify-between">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full px-6 py-3 border border-gray-200 text-gray-900 rounded-lg font-medium hover:bg-gray-50 transition-colors">
                Add to Wishlist
              </button>
            </div>
          </div>
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-6 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 flex flex-col h-full"
    >
      {/* Course Header */}
